...
<#
  ...
  (1.6.56). It does on Windows what install.sh does on Linux and macOS:
  ...
  Until 1.6.56 there was no Windows path at all: install.sh needs bash, and the app looked for
