...
mod tests {
    ...
    /// No markdown link reaches a sibling repository by a relative path (1.6.59; the owner's
    ...
    fn nenhum_link_relativo_para_repositorio_vizinho() {
        ...
        // 1.6.59 changelog entry does, and this ruler's first version failed on it).
