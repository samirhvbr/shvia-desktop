...
const TETO_DO_LOGIN: std::time::Duration = std::time::Duration::from_secs(15 * 60);
...
fn ler_url(saida: &mut std::process::ChildStdout) -> Option<String> {
    use std::io::Read;
...
fn url_de(linha: &str) -> Option<String> {
...
fn entregar_codigo(codigo: &str) -> Result<(), (&'static str, String)> {
...
#[cfg(test)]
// Split out of `tests_motor` in 1.6.41; it moves to login.rs with the code it checks.
mod tests_login {
    use super::*;
